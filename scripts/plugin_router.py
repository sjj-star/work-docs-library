...
def tool_config(params: dict) -> dict:
    ...
    group_map: dict[str, str] = {
        ...
        "LLM_TIMEOUT": "LLM 配置",
        "LLM_TIMEOUT_PER_10K_CHARS": "LLM 配置",
        "LLM_TIMEOUT_PER_IMAGE": "LLM 配置",
        "LLM_TIMEOUT_MAX": "LLM 配置",
        "HTTP_TIMEOUT": "HTTP 重试配置",
        "HTTP_RETRY_MAX_ATTEMPTS": "HTTP 重试配置",
        "HTTP_RETRY_BASE_DELAY": "HTTP 重试配置",
        "HTTP_RETRY_MAX_DELAY": "HTTP 重试配置",
        "HTTP_RETRY_JITTER": "HTTP 重试配置",
        "HTTP_RETRY_RESPECT_RETRY_AFTER": "HTTP 重试配置",
        "IMAGE_MAX_SIZE": "图片配置",
        "IMAGE_QUALITY": "图片配置",
        ...
        "EMBED_MAX_CHARS_PER_TEXT": "Embedding 配置",
        "EMBED_SPLIT_OVERLONG": "Embedding 配置",
